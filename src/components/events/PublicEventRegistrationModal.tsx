...
export function PublicEventRegistrationModal({ event, open, onClose }: Props) {
  ...
  const uiText = {
    ...
    participantPlaceholder: isUrdu ? "شرکت کنندہ کا مکمل نام" : "Participant full name",
    email: isUrdu ? "ای میل" : "Email",
    emailPlaceholder: "name@example.com",
    whatsapp: isUrdu ? "واٹس ایپ" : "WhatsApp",
    notes: isUrdu ? "نوٹس" : "Notes",
    notesPlaceholder: isUrdu ? "کوآرڈینیٹر کے لیے اختیاری نوٹس" : "Optional notes for the coordinator",
