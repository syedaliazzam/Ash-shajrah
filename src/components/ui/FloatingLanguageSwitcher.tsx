  ...
  return (
    <button
      ...
      className={`
        ...
        inline-flex min-h-[44px] min-w-[44px] items-center gap-2
    ...
    >
      <svg
        ...
        strokeWidth={2}
        stroke="currentColor"
        className="h-4 w-4 text-gold-soft"
        aria-hidden="true"
      >
        <path
          strokeLinecap="round"
      ...
      <span className={language === "en" ? "font-urdu text-base leading-none" : "font-display leading-none"}>
        {label}
      </span>
    </button>
  );
